...
const PRECIOS_PAN_BOCADILLO = {
    ...
    "Tostada": { normal: 1.5, sinGluten: 2 },
    "Bocadillo": { normal: 2, sinGluten: 3 },
    "Medio Bocadillo": { normal: 1.5, sinGluten: 2 }
};

const PRODUCTOS_MONTADITOS = [
    { nombre: "Sobrasada", precios: { Montadito: 2, Tostada: 2.5, Bocadillo: 3.5 } },
    { nombre: "Jamón York", precios: { Montadito: 2, Tostada: 3, Bocadillo: 4 } },
    { nombre: "Bacon", precios: { Montadito: 2, Tostada: 3, Bocadillo: 4 } },
    { nombre: "Queso con anchoa", precios: { Montadito: 2, Tostada: 3, Bocadillo: 4 } },
    { nombre: "Lomo", precios: { Montadito: 2, Tostada: 3.5, Bocadillo: 5 } },
    { nombre: "Atún", precios: { Montadito: 2.5, Tostada: 3, Bocadillo: 4.5 } },
    { nombre: "Catalana", precios: { Montadito: 2.5, Tostada: 3.5, Bocadillo: 5 } },
    { nombre: "Chorizo", precios: { Montadito: 2.5, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Tocino", precios: { Montadito: 2.5, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Longaniza", precios: { Montadito: 2.5, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Pastor", precios: { Montadito: 2.5, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Tradicional", precios: { Montadito: 3, Tostada: 4, Bocadillo: 5 } },
    { nombre: "Especial", precios: { Montadito: 3, Tostada: 4, Bocadillo: 5 } },
    { nombre: "Morcilla", precios: { Montadito: 3, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Serranito", precios: { Montadito: 3, Tostada: 4, Bocadillo: 6.5 } },
    { nombre: "Especial Ana", precios: { Montadito: 3.5, Tostada: 4, Bocadillo: 6 } },
    { nombre: "Salmón", precios: { Montadito: 4, Tostada: 5, Bocadillo: 6 } },
    { nombre: "Eloy", precios: { Montadito: 3.5, Tostada: 5, Bocadillo: 7 } },
    { nombre: "Blanco y Negro", precios: { Montadito: 3.5, Tostada: 5, Bocadillo: 7 } }
];
